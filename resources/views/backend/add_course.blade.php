                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your couse name" id="course" name="course">
                        </div>
                        @error('course')
                        <span style="color:red;"> {{ $message }}</span> 
                     @enderror
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter fees" id="fees" name="fees">
                        </div>
                        @error('fees')
                        <span style="color:red;"> {{ $message }}</span> 
                     @enderror
