                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter blog title"
                                                id="blog_title" name="blog_title" value="{{ old('blog_title', $blog->blog_title) }}"
                                                required>
                                            @error('blog_title')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="category_id" name="category_id" required>
                                                ...
                                                <option value="{{ $id }}"
                                                    {{ old('category_id', $blog->category_id) == $id ? 'selected' : '' }}>
                                                    {{ $category }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter blog slug"
                                                id="blog_slug" name="blog_slug" value="{{ old('blog_slug', $blog->blog_slug) }}"
                                                required>
                                            @error('blog_slug')
                                            <span style="color:red;"> {{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            @enderror
                                            @if ($blog->main_image)
                                            <img src="{{ asset('storage/' . $blog->main_image) }}" class="img-fluid mt-2" alt="Main Image">
                                            @endif
                                        </div>
                                    </div>
                                    <!--end col-->
