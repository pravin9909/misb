  ...
  <div class="page-title-area bg-21">
    <div class="container">
      <div class="page-title-content">
        <h2>Développement économique, durable, local et international</h2>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>DÉVELOPPEMENT
                          ÉCONOMIQUE, DURABLE,
                          LOCAL ET INTERNATIONAL</h2>
                        <p>Le doctorat favorise le développement
                          économique, durable et global par le biais
                          de la recherche de pointe.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{ asset('assets/images/Développement-économique-durable-local-et-international.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
