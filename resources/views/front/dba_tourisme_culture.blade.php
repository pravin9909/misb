                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        ...
                        <p> Recherche avancée dans le domaine du
                          tourisme culturel pour développer des
                          expériences de voyage durables à travers
                          le monde.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{ asset('assets/images/Tourism-Culture.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
