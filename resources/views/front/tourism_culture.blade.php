    ...
    <div class="container">
      <div class="page-title-content">
        ...
        <ul>
          ...
          <li class="active">Tourism & Culture</li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>TOURISME &
                          CULTURE</h2>
                        <p> Explorez le patrimoine culturel,
                          analysez les évolutions du
                          secteur du voyage et les
                          stratégies de gestion des
                          destinations, pour concevoir
                          des expériences singulières
                          destinées aux voyageurs du
                          monde.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/bbs-Tourism-Culture.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
