                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MANAGEMENT ET GESTION
                          HÔTELIÈRE</h2>
                        <p> Expertise en matière d'initiatives et
                          d'innovations dans le domaine de l'hôtellerie
                          et de la restauration, visant à stimuler le
                          secteur.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/Management-et-Gestion-hôtelière.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
