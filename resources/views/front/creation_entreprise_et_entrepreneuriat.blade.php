 ...
 <div class="page-title-area bg-21">
    <div class="container">
      <div class="page-title-content">
        <h2>Création d'entreprise et entrepreneuriat</h2>
        ...
        <ul>
          ...
          <li class="active">Création d'entreprise et entrepreneuriat</li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>CRÉATION
                          D'ENTREPRISE ET
                          ENTREPRENEURIAT</h2>
                        <p> Renforcez votre esprit
                          d'innovation, développez
                          des idées commerciales et
                          cultivez les compétences
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{ asset('assets/images/bbs-Création-dentreprise-et-entrepreneuriat.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
