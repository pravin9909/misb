    ...
    <div class="container">
      <div class="page-title-content">
        ...
        <ul>
          ...
          <li class="active">Marketing international</li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MARKETING
                          INTERNATIONAL</h2>
                        <p> Maîtrisez les nuances
                          culturelles, l'image de marque
                          mondiale et la portée
                          stratégique, en façonnant des
                          produits pour divers marchés
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{ asset('assets/images/bbs-Marketing-international.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                  <div class="download-pdf">
                    <a href="assets/BBS_MISB_BROCHURE.pdf"  download="BBS_MISB_BROCHURE.pdf"   
