    ...
    <div class="container">
      <div class="page-title-content">
        ...
        <ul>
          ...
          <li class="active">Management du luxe</li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MANAGEMENT DU
                          LUXE</h2>
                        <p> Plongez dans l'univers de
                          l'exception, perfectionnez
                          l'art du branding et
                          prenez les rênes du
                          domaine du luxe.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/bbs-Management-du-luxe.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
