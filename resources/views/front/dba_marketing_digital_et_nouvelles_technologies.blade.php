  ...
  <div class="page-title-area bg-21">
    <div class="container">
      <div class="page-title-content">
        <h2>Marketing digital et Nouvelles technologies</h2>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MARKETING DIGITAL ET
                          NOUVELLES TECHNOLOGIES</h2>
                        <p> Le marketing numérique dans
                          l'apprentissage universitaire couvre la
                          promotion en ligne, les stratégies basées sur
                          les données et les activités liées aux médias
                          sociaux, offrant des compétences pratiques
                          et innovantes dans le domaine.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/Marketing-digital-et-Nouvelles-technologies.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    <div class="download-pdf">
                      <a href="assets/DBA_MISB_BROCHURE.pdf" data-bs-toggle="modal" data-bs-target="#brochureModal" class="default-btn">
...
<script>
    ...
    var pdfUrl = "{{ asset('assets/DBA_MISB_BROCHURE.pdf') }}";
