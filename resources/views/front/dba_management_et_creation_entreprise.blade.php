  ...
  <div class="page-title-area bg-21">
    <div class="container">
      <div class="page-title-content">
        <h2>Management et création d'entreprise</h2>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MANAGEMENT ET CRÉATION
                          D'ENTREPRISE</h2>
                        <p> L'enseignement de la gestion et de la création
                          d'entreprise inclut esprit entrepreneurial,
                          planification, finance, marketing, et
                          opérations.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/Management-et-création-dentreprise.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
