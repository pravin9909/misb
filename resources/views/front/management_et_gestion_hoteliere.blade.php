 ...
 <div class="page-title-area bg-21">
    <div class="container">
      <div class="page-title-content">
        <h2>Management et Gestion hôtelière </h2>
        ...
        <ul>
          ...
          <li class="active">Management et Gestion hôtelière </li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MANAGEMENT ET
                          GESTION HÔTELIÈRE</h2>
                        <p> Apprenez à superviser les
                          opérations d'accueil, à créer
                          des expériences mémorables
                          pour les clients et à jouer un
                          rôle de premier plan dans le
                          secteur dynamique de
                          l'hôtellerie.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{ asset('assets/images/bbs-Management-et-Gestion-hôtelière.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="course-odf-bg">
              <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                  ...
                  <a href="assets/BBS_MISB_BROCHURE.pdf" download="BBS_MISB_BROCHURE.pdf" data-bs-toggle="modal" data-bs-target="#brochureModal" class="default-btn">
...
<script>
    ...
    var pdfUrl = "{{ asset('assets/BBS_MISB_BROCHURE.pdf') }}";
