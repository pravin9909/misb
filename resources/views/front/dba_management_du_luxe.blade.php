                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <div class="campus-content mr-15">
                        <h2>MANAGEMENT DU LUXE</h2>
                        <p>La gestion du luxe englobe la planification
                          stratégique, le marketing et les opérations
                          visant à préserver l'exclusivité et à
                          accroître la valeur des marques, produits
                          et services haut de gamme.</p>
                    ...
                    <div class="col-lg-7">
                      <div class="campus-img-2 ml-15">
                        <img src="{{asset('assets/images/Management-du-Luxe.jpeg')}}" alt="Image" />
                      </div>
                    </div>
                  </div>
                </div>
