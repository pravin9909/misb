...
class ToApplyController extends Controller
{
    ...
    public function to_apply_submit(Request $req)
    {
        ...
        $req->validate([
            ...
            'langSelect' => 'required',
            'passportsize' => 'required|file|mimes:pdf,doc,docx,jpeg,jpg,png,gif,svg|max:3072',
            'idcard' => 'required|file|mimes:pdf,doc,docx,jpeg,jpg,png,gif,svg|max:3072',
            'diploma' => 'required|file|mimes:pdf,doc,docx,jpg,jpeg,png,gif,svg|max:3072',
        ...
        // return $application;
        Session::put('lastId', $lastInsertedId);
        Session::put('pay_de_residence', $pay_de_residence);
        Session::put('otp', $otp);
        //dd($pay_de_residence);
